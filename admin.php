...
<body>
    <div class="container">
        ...
        <h1 class="my-5">
            Manage User <span class="badge bg-danger text-white"><?= count($all)?></span>
        </h1>
                    ...
                    <td>
                        <?php if($auth->value>1): ?>
                            <div class="dropdown btn-group ">
                                <a href="#" role="button" class="btn btn-sm btn-outline-primary dropdown-toggle" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                                    Change Role
                                </a>
                                ...
                                <?php else: ?>
                                    <a href="_actions/suspend.php?id=<?=$user->id?>" class="btn btn-sm btn-success">
                                        Active
                                    </a>
                                <?php endif ?>
